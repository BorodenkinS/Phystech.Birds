...
class Level:
    ...
    def level3(self):
        background_surf = pygame.image.load('Sprites\\bg 3 1200x600.jpg')
        ground_surf = pygame.image.load('Sprites\\grass.png')
        self.sc.blit(background_surf, background_surf.get_rect(bottomright=(1200, 600)))
        self.sc.blit(ground_surf, ground_surf.get_rect(bottomright=(1200, 600)))
    ...
    def level4(self):
        background_surf = pygame.image.load('Sprites\\bg 4 1200x600.jpg')
        ground_surf = pygame.image.load('Sprites\\grass.png')
        self.sc.blit(background_surf, background_surf.get_rect(bottomright=(1200, 600)))
        self.sc.blit(ground_surf, ground_surf.get_rect(bottomright=(1200, 600)))
    ...
    def level5(self):
        background_surf = pygame.image.load('Sprites\\bg 5 1200x600.jpg')
        ground_surf = pygame.image.load('Sprites\\grass.png')
        self.sc.blit(background_surf, background_surf.get_rect(bottomright=(1200, 600)))
        self.sc.blit(ground_surf, ground_surf.get_rect(bottomright=(1200, 600)))
